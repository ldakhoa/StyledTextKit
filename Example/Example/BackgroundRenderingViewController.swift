...
class BackgroundRenderingViewController: UIViewController {
    ...
    @objc private func tapAction() {
        present(SFSafariViewController(url: URL(string: "https://github.com/ldakhoa/StyledTextKit")!), animated: true, completion: nil)
    }

}

extension BackgroundRenderingViewController: StyledTextViewDelegate {
    func didTap(view: StyledTextKit.StyledTextView, attributes: StyledTextKit.NSAttributedStringAttributesType, point: CGPoint) {
